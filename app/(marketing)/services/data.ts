// app/(marketing)/services/data.ts
...
export const servicesData: Service[] = [
  // 交通サービス
  {
    ...
    overview: 'データ駆動型のスマート交通管理システムを通じて、都市の移動をより効率的かつ持続可能にします。AI技術と既存のインフラを融合させることで、コスト効率の高い交通最適化を実現し、市民生活の質向上と環境負荷軽減に貢献します。',
    challenges: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'システム導入後は継続的にデータが蓄積され、機械学習モデルが地域特性を学習することで、徐々に予測精度が向上していきます。地域特性や過去データの質により異なりますので、詳細は個別にご相談ください。'
      },
      {
  ...
  // 地域経済活性化
  {
    ...
    name: '地域経済活性化',
    category: 'revitalization',
    overview: '地域の人の流れを可視化し、その洞察に基づいた戦略立案を支援するソリューション。匿名化されたデータ分析により、商業エリアの活性化や観光戦略の最適化を科学的アプローチで実現し、地域の持続的な経済発展を促進します。',
    challenges: [
      '来街者数の減少と商店街の衰退',
      '観光客の行動パターンや嗜好の把握困難',
    ...
    faqs: [
      ...
      {
        question: 'どのようなメリットが期待できますか？',
        answer: '地域の人流データを可視化することで、効果的なイベント開催時期や商業施策の立案が可能になります。また、観光地では訪問者の行動パターンを理解し、より魅力的な周遊ルートや滞在時間延長につながる施策を検討できます。'
      }
    ],
    implementationProcess: [
      {
  ...
  // 防災・セキュリティ
  {
    ...
    name: '防災・セキュリティ',
    category: 'revitalization',
    overview: '先進的テクノロジーを活用した総合的な安全・安心ソリューション。AIによる予兆検知と迅速な対応により、市民の生命と財産を守る新時代の防災・セキュリティ基盤を提供します。',
    challenges: [
      '災害発生時の情報収集と避難誘導の遅れ',
  ...
  // 環境モニタリング
  {
    ...
    overview: '都市環境の質を可視化し、持続可能な未来へと導くデータ基盤を提供します。大気や騒音などの環境要素を継続的に計測し、その変化を追跡するとともに、AIによる予測分析を通じて、予防的な環境改善策を実現します。',
    challenges: [
      '都市部の大気汚染による健康リスク',
      '騒音・振動による生活環境悪化と苦情対応',
    ...
    faqs: [
      ...
      {
        question: 'データの精度はどうですか？',
        answer: '低コストセンサーを使用しながらも、独自のキャリブレーション技術と補正アルゴリズムにより、専門的な用途にも適した精度を実現しています。定期的な精度検証と調整を行い、信頼性を維持します。'
      },
      {
  ...
  // エネルギー最適化
  {
    ...
    name: 'エネルギー最適化',
    category: 'resource-management',
    overview: 'エネルギー消費の見える化から最適化までを一貫して支援する総合ソリューション。AIによる使用パターン分析と予測技術により、環境負荷の低減とコスト削減を両立させ、持続可能なエネルギー利用を実現します。',
    challenges: [
    ...
    faqs: [
      ...
      {
        question: '導入効果はどのように現れますか？',
        answer: '省エネ施策の内容により異なりますが、エネルギー使用の見える化によって無駄の発見と削減が可能になります。また、AI分析によって最適な運用パターンが提案され、継続的なコスト削減につながります。'
      },
      {
  ...
  // スマートインフラ管理
  {
    ...
    name: 'スマートインフラ管理',
    category: 'resource-management',
    overview: 'デジタル技術を活用した次世代のインフラ管理ソリューション。センサーとAIの連携により、インフラの状態を常時監視し、予測保全によるコスト削減と長寿命化を実現します。持続可能な都市基盤の形成と限られた資源の効率的活用を両立させます。',
    challenges: [
      'インフラの老朽化と維持管理コスト増大',
      '点検人員の不足と技術継承の課題',
      '突発的な故障・事故のリスク',
    ...
    benefits: [
      '予防的メンテナンスによる長期的コスト削減',
      'インフラ寿命の延長と突発的故障リスクの低減',
      '限られた予算・人員での効率的な維持管理の実現',
      '水資源の有効活用と漏水削減によるコスト削減'
    ],
    faqs: [
      {
      ...
      {
        question: '劣化予測にはどれくらいのデータが必要ですか？',
        answer: '初期モデルは類似インフラの一般的データを基に構築します。そのため、導入直後から一定の予測が可能です。自治体固有のデータが蓄積されるとともに、予測精度は段階的に向上していきます。'
      }
    ],
    implementationProcess: [
      {
